...
//        report.setUser(managedUser);  // ✅ Save user in report
//        report.setQuiz(quiz);
...
//
//        logger.info("📊 Creating report for user {} - Score: {}/{} ({}%) Grade: {}",
...
//        logger.info("✅ Report saved with ID: {} for user: {}",
...
//            if (result.getFeedback().startsWith("Evaluation failed") ||
//                    result.getFeedback().startsWith("Authentication failed")) {
//                logger.warn("⚠️ Skipping save for failed evaluation: Question {}",
...
//                answer.setReport(savedReport);  // ✅ Link to Report
//
//                // Save Answer
//                Answer savedAnswer = answerRepository.saveAndFlush(answer);
//                savedAnswersCount++;
//
//                logger.debug("✅ Saved answer {} for question {} linked to report {}",
//                        savedAnswer.getAnswerId(), result.getQuestionNumber(), savedReport.getId());
//
//                successfulResults.add(result);
//
//            } catch (Exception e) {
//                logger.error("❌ Failed to save answer for tqid {}: {}",
...
//        }
//
//        logger.info("📊 Complete: {}/{} answers saved, linked to report ID: {}",
